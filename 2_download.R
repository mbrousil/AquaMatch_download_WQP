...
p2_targets_list <- list(
  ...
  tar_target(p2_wqp_data_aoi_list,
             list(
               # "alkalinity" = p2_wqp_data_aoi_alk,
               "chlorophyll" = p2_wqp_data_aoi_chl,
               "doc" = p2_wqp_data_aoi_doc,
               "tss" = p2_wqp_data_aoi_tss,
               "sdd" = p2_wqp_data_aoi_sdd
               # "temperature" = p2_wqp_data_aoi_temp,
               # "phosphorus" = p2_wqp_data_aoi_phos, 
               # "nitrogen" = p2_wqp_data_aoi_nitro,
               # "ssc" = p2_wqp_data_aoi_ssc,
               # "poc" = p2_wqp_data_aoi_poc
             )),
